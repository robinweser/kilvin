...
export var responsiveStringMatrixProp = PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.arrayOf(PropTypes.arrayOf(PropTypes.string))), PropTypes.arrayOf(PropTypes.arrayOf(PropTypes.string))]);
